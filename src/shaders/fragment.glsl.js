// Extracted GLSL fragment shader for the metaball scene
export function getFragmentShader(isMobile, isSafari, isLowPowerDevice) {
    const precision = (isMobile || isSafari || isLowPowerDevice)
